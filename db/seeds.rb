...
skills = [{name: "Coding", description: "Knowledge in python,javaskript and sql", price: 25, level: 2},
        {name: "Cook a Basic Italian Meal", description: "First dive into the Italian cuisine", price: 10, level: 3},
        ...
        {name: "How to Pack a Suitcase", description: "On certain flights, having checked luggage can cost a great deal", price: 5, level: 5},
